                   ...
                   {modalReset && <Reset resetApp={resetApp} closeModalReset={closeModalReset}/>}
                        ...
                        <h6>
                          ...
                          consume. Puede usar como referencia la tabla de abajo o la galería de imágenes de porciones 
                          de 100 gramos de diferentes alimentos que se despliega con los botones de "abrir-cerrar". 
                          Al terminar el dia, oprimiendo el botón "entrar-dia", su recuento de carbohidratos
                           ...
                           y sin dieta si es mayor a 100. Este recuento quedara guardado en la memoria de su celular aunque
                            reinicie la App o apague su equipo. Así podrá llevar un control del tipo de dieta que hace y durante cuantos días.
                            El botón "Reset App" retorna todos los valores a cero perdiendo los datos guardados. La App está 
                            pensada para su uso en teléfonos móviles y es parte del sitio web Ketohoy.com.
                        </h6>
